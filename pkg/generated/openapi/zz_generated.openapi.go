...
func schema_kubewarden_runtime_enforcer_api_v1alpha1_AcknowledgedViolationRecord(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"violation": {
						SchemaProps: spec.SchemaProps{
							Description: "violation is the violation record acknowledged by users",
							Default:     map[string]interface{}{},
							Ref:         ref(v1alpha1.ViolationRecord{}.OpenAPIModelName()),
						},
					},
					"reason": {
						SchemaProps: spec.SchemaProps{
							Description: "reason is an optional field to indicate the reason this violation is acknowledged.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"acknowledgedAt": {
						SchemaProps: spec.SchemaProps{
							Description: "acknowledgedAt is the time when the violation was acknowledged",
		...
		Dependencies: []string{
			v1alpha1.ViolationRecord{}.OpenAPIModelName(), v1.Time{}.OpenAPIModelName()},
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"containerName": {
						SchemaProps: spec.SchemaProps{
							Description: "containerName is the container where the unauthorized executable ran.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"executablePath": {
						SchemaProps: spec.SchemaProps{
							Description: "executablePath is the path of the unauthorized executable.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"action": {
						SchemaProps: spec.SchemaProps{
							Description: "action is the enforcement action taken (monitor or protect).",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
...
func schema_kubewarden_runtime_enforcer_api_v1alpha1_WorkloadPolicy(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1alpha1.WorkloadPolicySpec{}.OpenAPIModelName()),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1alpha1.WorkloadPolicyStatus{}.OpenAPIModelName()),
						},
					},
				},
			},
		...
		Dependencies: []string{
			v1alpha1.WorkloadPolicySpec{}.OpenAPIModelName(), v1alpha1.WorkloadPolicyStatus{}.OpenAPIModelName(), v1.ObjectMeta{}.OpenAPIModelName()},
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"allowed": {
						SchemaProps: spec.SchemaProps{
							Description: "allowed defines a list of executables that are allowed to run",
							Type:        []string{"array"},
...
func schema_kubewarden_runtime_enforcer_api_v1alpha1_WorkloadPolicyList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "WorkloadPolicyList contains a list of WorkloadPolicy.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref(v1alpha1.WorkloadPolicy{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1alpha1.WorkloadPolicy{}.OpenAPIModelName(), v1.ListMeta{}.OpenAPIModelName()},
	}
}
...
func schema_kubewarden_runtime_enforcer_api_v1alpha1_WorkloadPolicyProposal(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "WorkloadPolicyProposal is the Schema for the workloadpolicyproposals API.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref(v1alpha1.WorkloadPolicyProposalSpec{}.OpenAPIModelName()),
						},
					},
				},
			},
		...
		Dependencies: []string{
			v1alpha1.WorkloadPolicyProposalSpec{}.OpenAPIModelName(), v1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_kubewarden_runtime_enforcer_api_v1alpha1_WorkloadPolicyProposalList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "WorkloadPolicyProposalList contains a list of WorkloadPolicyProposal.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref(v1alpha1.WorkloadPolicyProposal{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1alpha1.WorkloadPolicyProposal{}.OpenAPIModelName(), v1.ListMeta{}.OpenAPIModelName()},
	}
}
...
func schema_kubewarden_runtime_enforcer_api_v1alpha1_WorkloadPolicyProposalSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "WorkloadPolicyProposalSpec defines the desired state of WorkloadPolicyProposal.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"rulesByContainer": {
						SchemaProps: spec.SchemaProps{
							Description: "rulesByContainer specifies for each container the list of rules to apply.",
							Type:        []string{"object"},
							AdditionalProperties: &spec.SchemaOrBool{
								Allows: true,
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref(v1alpha1.WorkloadPolicyRules{}.OpenAPIModelName()),
									},
								},
							},
						},
		...
		Dependencies: []string{
			v1alpha1.WorkloadPolicyRules{}.OpenAPIModelName()},
	}
}
...
func schema_kubewarden_runtime_enforcer_api_v1alpha1_WorkloadPolicyRules(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			v1alpha1.WorkloadPolicyExecutables{}.OpenAPIModelName()},
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"mode": {
						SchemaProps: spec.SchemaProps{
							Description: "mode defines the execution mode of this policy. Can be set to either \"protect\" or \"monitor\". In \"protect\" mode, the policy blocks and reports violations, while in \"monitor\" mode, it only reports violations.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"nodesWithIssues": {
						SchemaProps: spec.SchemaProps{
							Description: "nodesWithIssues contains the status of each node with issues.",
							Type:        []string{"object"},
							AdditionalProperties: &spec.SchemaOrBool{
								Allows: true,
								Schema: &spec.Schema{
					...
					"totalNodes": {
						SchemaProps: spec.SchemaProps{
							Description: "totalNodes is the total number of nodes the policy is applied to.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"successfulNodes": {
						SchemaProps: spec.SchemaProps{
							Description: "successfulNodes is the number of nodes where the policy is successfully enforced.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"failedNodes": {
						SchemaProps: spec.SchemaProps{
							Description: "failedNodes is the number of nodes where the policy enforcement failed.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"transitioningNodes": {
						SchemaProps: spec.SchemaProps{
							Description: "transitioningNodes is the number of nodes where the policy is transitioning mode.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					...
					"acknowledgedViolations": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref(v1alpha1.AcknowledgedViolationRecord{}.OpenAPIModelName()),
									},
								},
							},
						},
...
func schema_kubewarden_runtime_enforcer_api_v1alpha1_violationRecordKey(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "violationRecordKey is the in-memory dedup key used to recognize the same logical violation across scrapes.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"podName": {
						SchemaProps: spec.SchemaProps{
