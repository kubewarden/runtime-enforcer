...
THIS_PKG="github.com/kubewarden/runtime-enforcer"
...
while read -r dir; do
    ...
    grep -rl '+k8s:openapi-model-package' "${SCRIPT_ROOT}/api" --include '*.go' \
...
kube::codegen::gen_client \
    --with-watch \
    --with-applyconfig \
    --applyconfig-openapi-schema <(go run "${SCRIPT_ROOT}/pkg/generated/openapi/cmd/models-schema") \
